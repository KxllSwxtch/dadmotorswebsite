...
export const metadata: Metadata = {
	...
	description:
		'Свяжитесь с компанией D.A.D Motors для получения консультации по экспорту автомобилей из Южной Кореи. Офисы в Корее, контактные телефоны и другие способы связи.',
	keywords: [
		'D.A.D Motors',
		'контакты',
		'автомобили из Кореи',
